/*
 * Phase C — Domain 2 question bank builder
 ...
 * CISSP-D02-Q0001..0160, validates, and writes:
 *   questions/domain-02-asset-security.json
 *
...
const output = {
  meta: {
    ...
    generated_by: 'scripts/d2/build.cjs',
    ...
    id_range: `CISSP-D02-Q0001..CISSP-D02-Q${String(questions.length).padStart(4, '0')}`,
...
fs.writeFileSync(
  path.join(ROOT, 'questions/domain-02-asset-security.json'),
  JSON.stringify(output, null, 2) + '\n',
  'utf8'
);

console.log('Questions:', questions.length);
console.log('Difficulty:', JSON.stringify(diffTally), '(target e25/m50/h25)');
console.log('Types:', JSON.stringify(typeTally));
console.log('Errors:', errors.length);
errors.slice(0, 40).forEach(e => console.log('  !', e));
if (errors.length) process.exit(1);
console.log('OK — wrote questions/domain-02-asset-security.json');
