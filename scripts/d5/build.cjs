/*
 * Phase C — Domain 5 question bank builder
 ...
 * CISSP-D05-Q0001..0160, validates, and writes:
 *   questions/domain-05-identity-access-management.json
 *
...
const output = {
  meta: {
    ...
    generated_by: 'scripts/d5/build.cjs',
    ...
    id_range: `CISSP-D05-Q0001..CISSP-D05-Q${String(questions.length).padStart(4, '0')}`,
...
fs.writeFileSync(
  path.join(ROOT, 'questions/domain-05-identity-access-management.json'),
  JSON.stringify(output, null, 2) + '\n',
  'utf8'
);

console.log('Questions:', questions.length);
console.log('Difficulty:', JSON.stringify(diffTally), '(target e26/m68/h36)');
console.log('Types:', JSON.stringify(typeTally));
console.log('Errors:', errors.length);
errors.slice(0, 40).forEach(e => console.log('  !', e));
if (errors.length) process.exit(1);
console.log('OK — wrote questions/domain-05-identity-access-management.json');
