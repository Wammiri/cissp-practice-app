/*
 * Phase C — Domain 8 question bank builder
 ...
 * CISSP-D08-Q0001..0160, validates, and writes:
 *   questions/domain-08-software-development-security.json
 *
...
const output = {
  meta: {
    ...
    generated_by: 'scripts/d8/build.cjs',
    ...
    id_range: `CISSP-D08-Q0001..CISSP-D08-Q${String(questions.length).padStart(4, '0')}`,
...
fs.writeFileSync(
  path.join(ROOT, 'questions/domain-08-software-development-security.json'),
  JSON.stringify(output, null, 2) + '\n',
  'utf8'
);

console.log('Questions:', questions.length);
console.log('Difficulty:', JSON.stringify(diffTally), '(target e20/m50/h30)');
console.log('Types:', JSON.stringify(typeTally));
console.log('Errors:', errors.length);
errors.slice(0, 40).forEach(e => console.log('  !', e));
if (errors.length) process.exit(1);
console.log('OK — wrote questions/domain-08-software-development-security.json');
